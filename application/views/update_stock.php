<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div class="row">
        <form method="POST" action="<?php echo base_url(); ?>index.php/main/update_stock">
            <div class="form-group">
                <label class="col-md-4 control-label text-right" for="item_name">Select Item: </label>  
                <div class="col-md-4">
                
                    <select class="form-control input-md" name="get_stock_desc" >
                    <?php if ($item_list == 'No Items' ){ ?>
                        <option>No Items</option>
                    <?php }else{ foreach ($item_list as $row): ?>
